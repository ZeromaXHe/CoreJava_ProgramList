//II 3-1: 140/818
//程序清单3-1：你可以使用File->Open菜单选项来读入一个XML文件。
//DocumentBuilder对象会解析这个XML文件，并产生一个Document对象。
//该程序会将Document对象显示为一个JTree。
package dom;
    ...
    public static JPanel elementPanel(Element e){
        ...
        panel.add(new JTable(new AbstractTableModel() {
            ...
            public Object getValueAt(int rowIndex, int columnIndex) {
                return columnIndex==0?map.item(rowIndex).getNodeValue():map.item(rowIndex).getNodeValue();
            }
        }));
        return panel;
    }
